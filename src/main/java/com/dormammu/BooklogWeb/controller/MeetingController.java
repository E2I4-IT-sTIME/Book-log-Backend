...
//    @ApiImplicitParams(
//            {@ApiImplicitParam(name= "image", value = "모임 이미지", dataTypeClass = Integer.class),
//                    @ApiImplicitParam(name= "name", value = "모임 이름", dataTypeClass = String.class),
//                    @ApiImplicitParam(name= "info", value = "모임 소개글", dataTypeClass = String.class),
//                    @ApiImplicitParam(name= "ment", value = "모임가입 멘트", dataTypeClass = String.class),
//                    @ApiImplicitParam(name= "max_num", value = "최대 인원", dataTypeClass = String.class),
//                    @ApiImplicitParam(name= "onoff", value = "온/오프라인", dataTypeClass = String.class),
//                    @ApiImplicitParam(name= "questions", value = "질문", dataTypeClass = String.class),
//                    @ApiImplicitParam(name= "hashtags", value = "해시태그", dataTypeClass = String.class)
//            }
//            )   // Swagger에 사용하는 파라미터에 대해 설명
    ...
    //@ApiImplicitParam(name = "id", value = "모임 id값", dataTypeClass = Integer.class)
...
//    @ApiImplicitParams(
//            {@ApiImplicitParam(name = "meeting_id", value = "모임 id값", dataTypeClass = Integer.class),
//                    @ApiImplicitParam(name = "answer_id", value = "답변 id값", dataTypeClass = Integer.class)
//            })
...
//    @ApiImplicitParams(
//            {@ApiImplicitParam(name = "meeting_id", value = "모임 id값", dataTypeClass = Integer.class),
//                    @ApiImplicitParam(name = "user_id", value = "유저 id값", dataTypeClass = Integer.class)
//            })
    ...
    public List<GetCategoryRes> searchCategory(@RequestParam("tagName") String tagName, Authentication authentication){
        PrincipalDetails principalDetails = (PrincipalDetails) authentication.getPrincipal();
